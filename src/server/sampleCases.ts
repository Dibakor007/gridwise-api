import { OptimizationRequest } from './types.ts';
...
export const SAMPLE_CASES: SampleCase[] = [
  {
    ...
    rationale: "Tests one relevant solar-reduction note plus one realistic distractor. The first note reduces usable solar to 25% for hours 12 and 13; the second must be no_op.",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests a hard no-charge maintenance window. Charging must be zero for hours 2, 3, and 4.",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests relative-language interpretation. 50% of 200 kWh = 100 kWh minimum reserve for hours 18, 19, and 20.",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests a hard no-discharge window during an expensive period. Discharge must be zero for hours 18 and 19.",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests a hard grid-import cap of 155 kWh in each of hours 18, 19, and 20.",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests multiple notes in one request: a 50% solar reduction, a no-charge window, and an unrelated distractor.",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests two simultaneous hard directives: a 90 kWh battery reserve (18..21) and a 180 kWh grid-import cap (19..20).",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests separate charging and discharging outages: charging prohibited (11..12), discharging prohibited (17..18).",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests percentage normalization: 80% solar reduction means 20% remains usable (factor = 0.2 for hours 11, 12, 13).",
    input: {
  ...
  },
  {
    ...
    rationale: "Tests combined evening directives: 80 kWh reserve (18..21), 190 kWh grid cap (19..21), and one distractor note.",
    input: {
